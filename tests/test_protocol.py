...
def test_plant_pro_spp_switch_packets_match_reference_capture():
...
def test_plant_pro_spp_mode_packets_match_reference_capture():
...
def test_plant_pro_spp_all_zone_packet_matches_reference_shape():
...
def test_plant_pro_spp_status_strips_d2_header_and_skips_schedule_blobs():
